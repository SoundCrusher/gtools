...
var ragex1 = regexp.MustCompile(`\s+--\w+\s+(".*"|'.*'|\w+\s)?`)
...
func Test_matchCurl(t *testing.T) {
	buf :=
		`curl 'https://api-yifeng.medlinker.com/admin-interface/proxy/v0/proxyPharmacy' \

  -h 'authority: api-yifeng.medlinker.com' \
  ...
  -H 'origin: https://business-new-yifeng.medlinker.com' \
  ...
  -H 'referer: https://business-new-yifeng.medlinker.com/' \

  -H 'accept-language: zh-CN,zh;q=0.9,en;q=0.8' \

  -H 'cookie: gr' \

  --data-raw '{"real_url":"/med.medication.service.v1.erp.StoreMapping/GetErpStoreMappingList","params":"{\"page\":2,\"pageSize\":10,\"channelId\":328,\"limit\":10}"}' \

  --compressed`
	curl, err := matchCurl(buf)
	if err != nil {
